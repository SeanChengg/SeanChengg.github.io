  ...
  return (
    <div id="motor-control" style={{ width: 1919, height: MOTOR_PID_HEIGHT, left: 0.75, top: MOTOR_PID_TOP, position: 'absolute' }}>
      ...
      <div style={{
        ...
        Once the Pico receives the line_position number over UART (0–20, where 10 means the line is dead centre), it needs to decide how to steer. That decision is made by a PID controller — Proportional, Integral, Derivative — a feedback algorithm that runs every motor cycle. It compares line_position to the target value of 10 to get an error: for example, receiving 12 means the line is 2 units to the right, so error = +2. If the line drifts right (position {'>'} 10), the PID output goes positive, slowing the left motor and speeding up the right to steer back. If it drifts left (position {'<'} 10), the opposite happens. The proportional term reacts to current error — bigger drift means harder correction. The derivative term reacts to how fast the error is changing, dampening overshoot and preventing zig-zag behavior. The integral term is disabled (Ki=0) to avoid instability in rapid line following.
      </div>

      <div className="ns" style={{ width: 1289, height: 350, left: 460, top: 570, position: 'absolute' }}>
        <GlassWidget small pixelColor="gray" style={{ left: 24, top: 120, width: 100, height: 52 }}>
        ...
        <GlassWidget small pixelColor="purple" style={{ left: 260, top: 113, width: 150, height: 68 }}>
        ...
        <GlassWidget small pixelColor="purple" style={{ left: 460, top: 113, width: 150, height: 68 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
        ...
        <GlassWidget small pixelColor="purple" style={{ left: 652, top: 103, width: 110, height: 40 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
            <div style={{ fontFamily: 'Inter,sans-serif', fontWeight: 600, color: '#1a1a1a', fontSize: 11 }}>L Motor</div>
          </div>
        </GlassWidget>
        <GlassWidget small pixelColor="purple" style={{ left: 652, top: 153, width: 110, height: 40 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
